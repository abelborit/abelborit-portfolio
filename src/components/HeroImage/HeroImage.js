    ...
    <div className={styles.heroImage}>
      <div className={styles.heroImage_opacity}>
        <div className={styles.vanishIn}>
          <div className={`${styles.heroImage_content} ${styles.gradientMove}`}>
            <div className={styles.heroImage_text}>
              ...
              <p>
                ...
                llevar acabo la maquetación, diseño e interactividad de
                interfaces web, quiero seguir mejorando y aprendiendo nuevas
